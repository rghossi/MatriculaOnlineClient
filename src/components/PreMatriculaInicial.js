...
class PreMatriculaInicial extends Component {
  render() {
    return (
      <div>
        ...
        <div className="grey lighten-2">
          <div className="row">
            ...
            <div className="col s4">
              ...
              <p className="center-align"><a className="waves-effect waves-light btn indigo" onClick={() => browserHistory.push('pre-matricula')}><b>Pré-Matrícula</b></a></p>
              <div className="section"></div>
            </div>
          </div>
        </div>
...
export default PreMatriculaInicial;